...
export default function DashboardFilters({ filtros, onChange }) {
  const olasConClientes = OLAS.filter((o) => o.clientes.length > 0)

  return (
    <div className="filtros-bar">
      <div className="filtros-copy">
        <div className="dashboard-section-eyebrow">Detalle</div>
        <div className="filtros-title">Filtrar clientes</div>
      </div>
